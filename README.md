...
|------|------|----------------|
| Sara ValiPoor | BPM, SQL & Process Improvement | BPMN As-Is/To-Be, Analytical Queries, Views, SP, RFM, Task 5, Storytelling |
| Narges Heidari | Power BI & Dashboard | 3-page Dashboard, DAX Measures, Dashboard Screenshots, Performance Optimization |
